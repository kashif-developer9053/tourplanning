...
@section('title', 'General Assistant')
    ...
    <div class="row vh-100">
        ...
        <div class="col-lg-6 d-flex flex-column justify-content-center align-items-center bg-light text-center border-end">
            <h2 class="text-danger mb-4">
                <i class="fas fa-comments"></i> General AI Response
            </h2>
            <div id="result-container" class="w-75">
                <div id="loader" style="display: none;">
                    ...
                    <p class="mt-3">Fetching your response...</p>
                </div>
        ...
        <div class="col-lg-6 d-flex flex-column justify-content-center">
            <div class="card shadow-lg border-0 p-4" style="height: 100%;">
                <h1 class="text-center text-danger mb-4" style="padding-top: 10%;">
                    <i class="fas fa-robot"></i> General Assistant
                </h1>
                <form id="generalForm" class="needs-validation">
                    <div class="mb-4">
                        <label for="query" class="form-label fs-5" style="padding-top: 10%;">Enter Your Message:</label>
                        <textarea id="query" class="form-control form-control-lg" rows="5" placeholder="Type your query" required></textarea>
                    </div>
                    <div class="text-center">
                        <button type="button" class="btn btn-danger btn-lg w-100" onclick="handleGeneralAssistant()">
...
<script>
    async function handleGeneralAssistant() {
        ...
        const prompt = `Provide a concise, accurate, and helpful response to the following query: "${query}".`;
